...
class CalendarPopUp: UIView {
    ...
    @IBAction func GetDateOk(_ sender: Any) {
        print("============")
        print(NSDate(timeIntervalSince1970: selectedDate.timeIntervalSince1970))
        print("============")
    ...
    func setCalendar() {
        ...
        calendarView.backgroundColor = Constant.ColorCode.greenBlue2
        calendarView.layer.masksToBounds = true
        calendarView.layer.cornerRadius = 10
        backgroundColor = Constant.ColorCode.greenBlue3
        dateBarView.backgroundColor = Constant.ColorCode.greenBlue4
    ...
    func setupViewsOfCalendar(from visibleDates: DateSegmentInfo) {
        ...
        let monthName = GetChineseMonth(month: month)
    ...
    func setDate() {
        ...
        let week = GetWeekday(weekday: weekday)
